...
class CoreDataStackManager {
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "io.hagi.Data" in the application's documents Application Support directory.
...
let dataStack = CoreDataStackManager.sharedInstance
